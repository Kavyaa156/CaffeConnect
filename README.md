...
This project started as a [frontend-only Cafe Finder App](https://github.com/Kavyaa156/Cafe-Finder-app) built with vanilla JavaScript. I later evolved it into a full-stack application by:
